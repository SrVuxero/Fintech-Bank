...
@section('content')
   ...
   <div class="sambutan">
     <h1 class="text-xl font-bold">Selamat Datang Di Vuxero Store</h1>
   </div>
   <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
    <div class="card h-fit bg-base-100 shadow-xl font-semibold text-xl mt-6 pb-8 relative">
        ...
        @foreach (Auth::user()->wallet as $user_wallet )
            ...
            <h1 class="balance text-4xl mt-4 font-bold text-black dark:text-white">
                Rp.{{ $user_wallet->credit }}
            </h1>
            @endif

            @endforeach
        <a href="{{ route('topup.index') }}" class="top-up-btn absolute bottom-4 right-8 bg-blue-950 text-white py-2 px-4 rounded-lg">
            Top Up
        </a>
      @else
        <div class="title">
       ...
       @foreach ($products as $product )
         <div class="product-card card bg-base-100 shadow-xl overflow-hidden">
            <div class="content-img">
                <img src="https://images.pexels.com/photos/1099680/pexels-photo-1099680.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="">
            </div>
